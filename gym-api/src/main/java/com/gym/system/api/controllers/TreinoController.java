...
@CrossOrigin(origins = "*")
@Tag(name = "Treinos", description = "Endpoints para criar, atualizar, consultar e avaliar treinos dos alunos")
public class TreinoController {
    ...
    @ExampleObject(name = "Exemplo de criação de treino", value = """
            ...
            """)))
    @PostMapping("/criar")
    public ResponseEntity<?> criarTreino(@RequestBody CriarTreinoRequest request) {
        try {
    ...
    public ResponseEntity<?> cadastrarAluno(@RequestBody AlunoRequest alunoData) {
        try {
    ...
    @PostMapping("/aluno/{matricula}/treino")
    public ResponseEntity<?> criarTreinoParaAlunoExistente(
    ...
    public ResponseEntity<?> atualizarTreino(
            @Parameter(description = "Matrícula do aluno", example = "ALU-1717182829292")
            @PathVariable String matricula,
            @Parameter(description = "Dia da semana", example = "MONDAY")
            @RequestParam String dia,
    ...
    @PostMapping("/avaliar/{matricula}")
    public ResponseEntity<?> avaliarDesempenho(
            @Parameter(description = "Matrícula do aluno", example = "ALU-1717182829292")
            @PathVariable String matricula,
            @Parameter(description = "Dia da semana", example = "MONDAY")
            @RequestParam String dia,
    ...
    public ResponseEntity<?> obterTreinoDia(
            @Parameter(description = "Matrícula do aluno", example = "ALU-1717182829292")
            @PathVariable String matricula,
            @Parameter(description = "Dia da semana", example = "MONDAY")
    ...
    @GetMapping("/aluno/{matricula}/existe")
    public ResponseEntity<?> existeAluno(
            @Parameter(description = "Matrícula do aluno", example = "ALU-1717182829292")
            @PathVariable String matricula) {
        try {
    ...
    @GetMapping("/aluno/{matricula}/cronograma")
    public ResponseEntity<?> obterCronogramaAluno(
            @Parameter(description = "Matrícula do aluno", example = "ALU-1717182829292")
            @PathVariable String matricula) {
        try {
            Aluno aluno = treinoService.obterAluno(matricula);
    ...
    @GetMapping("/aluno/{matricula}/treino/{dia}/exercicios")
    ...
    @PostMapping("/{matricula}/exercicios/adicionar")
    public ResponseEntity<?> adicionarExercicio(
            @Parameter(description = "Matrícula do aluno", example = "ALU-1717182829292")
            @PathVariable String matricula,
            @Parameter(description = "Dia da semana", example = "MONDAY")
            @RequestParam String dia,
    ...
    @DeleteMapping("/{matricula}/exercicios/{nomeExercicio}")
    ...
    @DeleteMapping("/aluno/{matricula}/treino/{dia}")
    ...
    @DeleteMapping("/aluno/{matricula}/cronograma")
    public ResponseEntity<?> limparCronograma(
            @Parameter(description = "Matrícula do aluno", example = "ALU-1717182829292")
            @PathVariable String matricula) {
        try {
    ...
    public ResponseEntity<?> buscarAlunoPorCpf(
    ...
    public ResponseEntity<?> buscarAlunoPorEmail(
    ...
    @GetMapping("/total")
    public ResponseEntity<?> totalTreinosCadastrados() {
        try {
    ...
    @Schema(description = "Requisição para criar um treino para um aluno")
    public static class CriarTreinoRequest {
        @Schema(description = "Dados do aluno", requiredMode = Schema.RequiredMode.REQUIRED)
        public AlunoRequest aluno;
        @Schema(description = "Dia da semana do treino", example = "MONDAY", requiredMode = Schema.RequiredMode.REQUIRED)
        public String dia;
        @Schema(description = "Dados do treino diário", requiredMode = Schema.RequiredMode.REQUIRED)
        public TreinoRequest treino;
    }

    @Schema(description = "Dados de entrada de um aluno")
    public static class AlunoRequest {
        @Schema(description = "CPF do aluno", example = "123.456.789-00", requiredMode = Schema.RequiredMode.REQUIRED)
        public String cpf;
        @Schema(description = "Nome completo do aluno", example = "João Silva", requiredMode = Schema.RequiredMode.REQUIRED)
        public String nome;
        @Schema(description = "Data de nascimento no formato ISO", example = "1995-05-15", requiredMode = Schema.RequiredMode.REQUIRED)
        ...
        public String email;
        @Schema(description = "Matrícula do aluno. Opcional, pois o sistema pode gerar automaticamente.", example = "ALU-1717182829292")
        public String matricula;
        @Schema(description = "Nível de experiência do aluno", example = "INICIANTE")
        public String nivelExperiencia;
    }

    @Schema(description = "Dados de um treino diário")
    public static class TreinoRequest {
        @Schema(description = "Grupo muscular trabalhado no treino", example = "Peito", requiredMode = Schema.RequiredMode.REQUIRED)
        ...
        public List<ExercicioRequest> exercicios;
    }

    @Schema(description = "Dados de um exercício")
    public static class ExercicioRequest {
        @Schema(description = "Nome do exercício", example = "Supino", requiredMode = Schema.RequiredMode.REQUIRED)
        public String nome;
        @Schema(description = "Descrição do exercício", example = "Supino reto com barra")
        public String descricao;
        @Schema(description = "Quantidade de séries", example = "3")
        public Integer series;
        @Schema(description = "Quantidade de repetições", example = "10")
        public Integer repeticoes;
        @Schema(description = "Tempo de descanso em segundos", example = "60")
        public Integer descanso;
        @Schema(description = "Carga utilizada em kg", example = "80")
        public Integer carga;
    }

    @Schema(description = "Dados para avaliação de desempenho")
    public static class AvaliacaoRequest {
        @Schema(description = "Quantidade de exercícios completados pelo aluno", example = "3")
        public Integer exerciciosCompletados;
        @ArraySchema(schema =
        @Schema(description = "Carga usada em cada exercício", example = "80"), arraySchema =
        @Schema(description = "Lista de cargas utilizadas"))
        public List<Integer> cargas;
    }

    @Schema(description = "Resposta padrão das operações")
    public static class RespostaPadrao {
        @Schema(description = "Indica se a operação foi concluída com sucesso", example = "true")
        public boolean sucesso;
        @Schema(description = "Mensagem da operação", example = "Treino criado com sucesso")
        public String mensagem;
        @Schema(description = "Matrícula do aluno", example = "ALU-1717182829292")
        public String matriculaAluno;
    }

    @Schema(description = "Resposta de erro")
    public static class ErroResponse {
        @Schema(description = "Mensagem de erro", example = "Dia da semana inválido")
        public String erro;
    }

    @Schema(description = "Resposta da avaliação de desempenho")
    public static class AvaliacaoResponse {
        @Schema(description = "Relatório textual de avaliação do desempenho")
